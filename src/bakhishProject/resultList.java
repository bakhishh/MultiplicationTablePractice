...
public class resultList {
	...
	resultList() {
		...
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Student Name","Exam Name" , "Number Of Questions" ,"Number Of Correct Answers", "Time"}));
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					resultList window = new resultList();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
